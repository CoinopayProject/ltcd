...
func (s *utxoCache) addTxOuts(tx *ltcutil.Tx, blockHeight int32) error {
...
// from the cache.
func (s *utxoCache) addTxIns(tx *ltcutil.Tx, stxos *[]SpentTxOut) error {
...
func (s *utxoCache) connectTransaction(
	tx *ltcutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (s *utxoCache) connectTransactions(block *ltcutil.Block, stxos *[]SpentTxOut) error {
